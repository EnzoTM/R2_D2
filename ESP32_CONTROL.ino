...
const int motorb_dir = 26; //controla a direção do motor (ir pra frente ou tras)

const int motorA_pwm = 25; // PWM do Motor A é a potencia/velocidade do motor
const int motora_dir = 33; //controla a direção do motor (ir pra frente ou tras) 
